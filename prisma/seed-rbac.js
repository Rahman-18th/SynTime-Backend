...
async function main() {
    ...
    if (!adminRole) {
        throw new Error('Admin role not found. Create role "admin" first.');
    }
    console.log(`Admin role found: ${adminRole.name} (${adminRole.id})`);
    for (const permissionData of permissions) {
        ...
        console.log(`✓ ${permission.name} assigned to admin`);
    }
    ...
    console.log(`Admin permissions: ${adminPermissionCount}`);
}
main()
    .catch((error) => {
